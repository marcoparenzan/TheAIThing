...
public class MqttBrokerService([ServiceKey] string serviceKey, IConfiguration config, IServiceProvider sp, ILogger<MqttBrokerService> logger) : IWorkerService
{
    ...
    public async Task ExecuteAsync()
    {
        ...
        var retainServiceName = workerConfig["retainServiceName"];
        var retain = sp.GetKeyedService<IRetainedMessageService>(retainServiceName);
